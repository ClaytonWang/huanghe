...
from source.services.cluster.k8s.model.generic_mixin import GenericMixin
from source.services.cluster.k8s.const.crd_kubeflow_const import ISTIO_DISABLE_INJECT_ANNOTATION
